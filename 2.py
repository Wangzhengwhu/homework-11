...
class INVERSE(object):
    ...
    '''
    def __init__(self, _beta=1.95, _e=0., _m=4*(pi**2), _dt=0.001, _time=10):
        self.m=_m
        self.e=_e
        self.x, self.y=[1.],[0.]
...
ax1.set_title(r'$\beta=1.95$'+'  '+r'$e=0$',fontsize=18)
ax2.set_title(r'$\beta=1.95$'+'  '+r'$e=0.15$',fontsize=18)
ax3.set_title(r'$\beta=1.95$'+'  '+r'$e=0.45$',fontsize=18)
